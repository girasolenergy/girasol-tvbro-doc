...
リモート監視（Heartbeat）機能は、端末の状態データをKanbanBroのサーバーに一定間隔で送信し、専用の[リモート監視モニター](https://kanbanbro.pplc.co/heartbeat_monitor/)で起動状態を確認できる機能です。
...
[リモート監視モニター](https://kanbanbro.pplc.co/heartbeat_monitor/)へのリンクです。
