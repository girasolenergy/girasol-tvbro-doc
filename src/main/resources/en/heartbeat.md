...
Log in and log out using a Google account.

If you are not logged in, the Heartbeat feature is not available.
...
You can check UID (the currently logged-in user's ID) and FID (a unique ID per installation).
